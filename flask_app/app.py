...
edges = [("A","B",17),("A","C",18),("A","D",15),("B","C",18),("B","G",27),("B","E",18),("C","E",15),
         ("C","F",10),("D","F",14),("D","I",29),("F","I",13),("E","F",4),("E","G",6),("G","J",15),
         ("E","H",12),("F","H",17),("H","J",11),("I","H",3),("I","J",13)]
node_layout = {"A":(0,2),"B":(1.5,3.2),"C":(1,2),"D":(0.2,0.6),"E":(3,2.6),"F":(3,1.1),
               "G":(5,3.2),"H":(4.2,1.9),"I":(3.8,0.2),"J":(5.8,1.9)}
...
def index():
    ...
    if request.method=="POST":
        ...
        if s and e:
            if s == e:
                pt, c = [positions[s]], 0
            elif tuple(sorted((s,e))) in net_pairs:
    ...
    if pt and len(pt)>1:
        ...
        plt.scatter(xs[0], ys[0], c="lime", s=50)
        plt.scatter(xs[-1], ys[-1], c="cyan", s=50)
    plt.xlim(-1, N)
    plt.ylim(-1, N)
    plt.axis("off")
    plt.tight_layout()
